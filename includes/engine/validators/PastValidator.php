 ...
 * File: PastValidator.php
 **/

import('engine.validators.IValidator');

/** Verifica se a data esta no passado
 * @author Silas R. N. Junior
 */
class PastValidator implements IValidator {
	...
	public static function isValid($value) {
		...
		return (time() - $date1Int) > 0 ? true : false;
	}
	...
	public static function message() {
		return "A data nao se encontra no passado.";
	}
}
