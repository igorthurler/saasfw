	...
	public static function getDriver($driverCode) {
		switch ($driverCode) {
			...
			case 'mysql':
				...
				break;
			case 'mysqli':
				import('engine.db.drivers.MySQLiDriver');
				return new MySQLiDriver();
				break;
			case 'sqlite':
				import('engine.db.drivers.SQLiteDriver');
				return new MySQLDriver();
				break;
			default:
				throw new DbDriverException('Driver nao encontrado. [suportados: mysql,mysqli, pgsql, sqlite]');
		}
	}
