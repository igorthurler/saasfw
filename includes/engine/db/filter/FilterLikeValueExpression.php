...
class FilterLikeValueExpression extends FilterValueExpression {
    ...
    public function toSql(EntityFilter $entityFilter) {
        ...
        return $entityFilter->getDAO()->getDriver()->toUpper($entityFilter->getDAO()->getDriver()->formatTable($alias).".".$entityFilter->getDAO()->getDriver()->formatField($refrProperty->getColumnName()))
        .$this->getOperand()
