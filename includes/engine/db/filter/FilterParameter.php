...
import('engine.db.filter.FilterCondition');
import('engine.db.filter.FilterValueExpression');
import('engine.db.filter.FilterLikeValueExpression');
import('engine.db.filter.FilterPropertyExpression');
...
class FilterParameter {
    ...
    public static function isIn($property, $valuesArray) {
        if (!is_array($valuesArray)) $valuesArray = array($valuesArray);
